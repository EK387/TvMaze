...
import com.ernad.tvmaze.ui.list.TvMazeListAdapter
...
fun bindRecyclerView(recyclerView: RecyclerView, data: List<MazeObject>?) {
    val adapter = recyclerView.adapter as TvMazeListAdapter
